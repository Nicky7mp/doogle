// let dogList1 = [
//     "Puppercino", "westee", "Poddle", "Yorkshire Tea", "floof", "doge"
// ]
...
// let crossbeeds = {
//     Alaskan_Shepherd: ["Puppercino", "westee"],
//     Augie: ["westee", "Poddle"],
//     Ausky: ["Poddle", "Yorkshire Tea"],
//     Aussiedoodle: ["Yorkshire Tea", "floof"],
//     Bagle: ["floof", "doge"]
// }
...
class Crossbreed {
    ...
    //         if (value.includes(this.dog1) && value.includes(this.dog2)) {
    //             return(key)
    //         }
    //     }
    //     // console.log("I'm sorry, we don't have a result for that combination at the moment.")
    ...
    // }
    // generator() {
    //     return `You have chosen a ${this.dog1} and a ${this.dog2}.`
    // }
}
/////////////////////////////////^^^^^Crossbreed Generator Class^^^^^^/////////////////////

const firstDogChoice = document.querySelector('.dog1')

firstDogChoice.addEventListener('change', (event) => {

    let dogChoice1 = event.target.value                        //Saving choice as variable

    const choiceOne = document.querySelector('.choiceOne')
    choiceOne.textContent = `You chose a ${dogChoice1}`        //Printing dog1 to page

    let dogList2 = filterDogList(dogChoice1)                   //Saving filtered list to variable

    let dropdown2 = document.getElementById("selectDog2")      //Target 2nd list

    populateList(dogList2, dropdown2)                         //Fill 2nd list with new array
    

    Crossbreed.dog1 = dogChoice1
    console.log(Crossbreed.dog1)

    // new Crossbreed (dogChoice1, null)
    // console.log(Crossbreed)

    // new Crossbreed (event.target.value, "tbc")
    // console.log(Crossbreed)

    // return Crossbreed.dog1
    return Crossbreed.dog1 = dogChoice1
})

///////////////^^^^^^^^On Selection Of Dog 1^^^^^^^^^//////////////////////

const secondDogChoice = document.querySelector('.dog2')
...
secondDogChoice.addEventListener('change', (event) => {
    ...
    result.textContent = `Your choices create a ${generator(Crossbreed.dog1, Crossbreed.dog2)}`

    // Crossbreed.generator
    // console.log(Crossbreed.generator)
})

///////////^^^^^^^^On Selection Of Dog 2^^^^^^^^//////////////
...
// const result = new Crossbreed(dogList1[1], dogList1[2])

///////////////////////////^^^^Creating New Crossbreed Result^^^^^^//////////////////////

// console.log(result.newCrossbreed)
